...
def fraction_selector(label, unique_key, current_val=0.0):
    ...
    # FIX: provide explicit column width ratios for Inches, Fraction, and spacer
...
if page == "Challenge Measurements":
    ...
    try:
        ...
        for p in profiles.data:
            user_points = sum([l.get("daily_score", 0) for l in all_logs.data if isinstance(l, dict) and l.get("user_id")
